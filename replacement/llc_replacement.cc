    ...
    if (way == NUM_WAY) {
        ...
        for (way=0; way<NUM_WAY; way++) {
            if (block[set][way].lru == NUM_WAY-1) {
				...
				//Incrementing counters for in core and cross core eviction	

				/*if(block[set][way].cpu == cpu)
				{
					ice_count[cpu]++;
					//cout << " Debugging - Incremented ICE_Count" << endl;
				}
				else
				{
					cce_count[cpu]++;
					//cout << " Debugging - Incremented CCE_Count" << endl;
				}*/
